...
# PATH should be in zshenv, but can get reset in /etc/zprofile.
# So we source here and in ~/.zprofile
source ${HOME}/.zpath


asmrmpv() {
while sleep 1; do mpv -fs "$(find . -mindepth 1 -type f | sort -R | tail -n 1)" --af=lavfi="[dynaudnorm=s=30]"
done
}
